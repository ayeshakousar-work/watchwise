...
function GraphicalRepresentation() {
  ...
  return (
    <div className="dashboard-wrapper container-fluid py-3 px-4"style={{marginTop:"-30px"}}>
...
{/* WorkingDonut */}
<div className="card-box compact" style={{ height: '280px', width: '320px',marginLeft:"715px",marginTop:"-200px" }}>
...
<div className="container" style={{width:"529px",marginTop:"-300px",height:"195px",marginLeft:"180px"}}>
  <div className="row justify-content-center"  >
    ...
    <div className="col-md-6 col-lg-4 mb-4" style={{  width:"579px",marginLeft:"-10px",marginTop:"-10px"}}>
      <WorkingDonut predictions={predictions} />
    </div>
  </div>
</div>

<div className="card-box compact p-2 me-4" style={{ height: '70px', width: '729px',marginTop:"-45px",marginLeft:"-20px" }}>
  <Gauge predictions={predictions} />
      ...
      {/* Row 3: Bar Charts */}
      <div className="row mb-4" style={{marginTop:"200px"}}>
